...
public class Injector {
    ...
    private static final String dbUrl = Optional.ofNullable(System.getenv("MONGODB")).orElse("mongodb://192.168.17.118:27017");
     ...
     */
    public void registerService(String id, String name, String address) {
        Document service = new Document("id", id)
                .append("ServiceName", name)
                .append("ServiceAddress", address);
